...
DOCUMENTATION = r'''
---
module: veeam_vbr_rest_cloudcredentials_info

short_description: Get Veeam Backup & Replication Cloud Credentials.
...
- name: Test Veeam RestAPI Collection
  hosts: localhost
  tasks:
    - name: Test veeam_vbr_rest_cloudcredentials_info
...
def run_module():
    ...
    request_url = 'https://' + request_server + ':' + request_port + '/api/v1/cloudcredentials'
